...
- Don't send any URL that isn't `http://gcworkflow.clemson.edu:8080/...`. If you're about to send something else, you've gone wrong — stop and rewrite under `/var/www/sites/`.
