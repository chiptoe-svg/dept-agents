...
// ── Role personas ───────────────────────────────────────────────────────────
// Formerly lived under the (now-deleted) classroom scenario profile
// (src/scenarios/classroom/personas.ts). Relocated here — the platform code
// that outlives that profile — for local use (provisionStudent) and export
// for existing importers (scripts/class-skeleton, scripts/refresh-student-personas).
